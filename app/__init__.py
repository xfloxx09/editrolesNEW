# app/__init__.py (with step 16.5 removed to fix parameter error)
...
def create_app(config_class=Config):
    ...
    with app.app_context():
        ...
        # 16.5. Ensure all role_id values are valid (point to existing roles) - REMOVED because it causes parameter binding error
        # The check is not strictly necessary as we just assigned defaults.
