...
def create_app(config_class=Config):
    ...
    with app.app_context():
        ...
        # This runs only once per team member
        ...
        if team_members_without_user:
            ...
            if not mitarbeiter_role:
                ...
                for tm_id, tm_name, team_id in team_members_without_user:
                    ...
                    project_row = conn.execute(text("SELECT project_id FROM teams WHERE id = :team_id"), {"team_id": team_id}).fetchone()
                    if not project_row:
                    ...
                    conn.execute(
                        ...
                        """),
                        {"username": username, "password_hash": password_hash, "role_id": role_id, "project_id": project_id}
                    )
